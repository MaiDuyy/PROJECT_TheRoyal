...
public class ThemKhuyenMai_Dialog extends JDialog {
    ...
    public void GUI() {
        ...
        HeaderTitle title = new HeaderTitle("THÊM KHUYẾN MÃI");
...
//                      String gioiTinh = nv.isGioiTinh() ? "Nữ" : "Nam";
                      home.tableModelUD.addRow(new Object[] {
                     maKM,km.getTenKM(),giaTriPhanTram, ngaysinh, ngayvaolam, km.getMoTaKM(), km.getSoLuong()
                      });
                      home.thongBao(0, "Thêm khuyến mãi thành công");
                      home.showMessage("Thêm khuyến mãi thành công", SUCCESS);
                      dispose();
                      home.tableModelUD.fireTableDataChanged();
                      home.loadListUuDai();
                  } else {
                	  home.thongBao(2, "Thêm khuyến mãi thất bại");
                      home.showMessage("Lỗi: Thêm khuyến mãi thất bại", ERROR);
                  }
              } catch (Exception e1) {
                  e1.printStackTrace();
              }
