...
public class QLPhong_GUI extends JInternalFrame implements ActionListener {
	...
	private ThemPhong_Dialog themphongdialog;
	        ...
	        modelLoc = new DefaultComboBoxModel < String > (new String[] {
		        ...
		        cbxLoc.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						switch (selectedItem) {
						case "Phòng đơn":
			                  dsPhong = TimPhong.getInstance().searchPhongVip(selectedItem);
							break;
						case "Phòng đôi":
			                  dsPhong = TimPhong.getInstance().searchPhongVip(selectedItem);
							break;
						case "Phòng Penthouse":
							...
							break;
						case "Phòng trống":
			                  dsPhong = TimPhong.getInstance().searchTrangThai(selectedItem);
							break;
						case "Đang ở":
			                  dsPhong = TimPhong.getInstance().searchTrangThai(selectedItem);
							break;
...
//	        controlPanel.add(btnLocNgayKetThuc);
	        ...
	        txtTim.addKeyListener(new KeyAdapter() {
	            ...
	            public void keyReleased(KeyEvent e) {
	                ...
	                case "Tất cả":
	                    ...
	                    dsPhong = TimPhong.getInstance().searchTatCa(searchContent);
	                    break;
	                case "Tên phòng":
	                    dsPhong = TimPhong.getInstance().searchTen(searchContent);
	                    break;
	                case "Mã phòng":
	                    dsPhong = TimPhong.getInstance().searhMa(searchContent);
	                    break;
    ...
    public Phong getSanPhanSelect() {
        ...
        String maNV = tblPhong.getValueAt(i_row, 0).toString();
        return PhongDAO.getInstance().getPhongByMaPhong(maNV);
    }
