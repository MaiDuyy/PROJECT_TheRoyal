...
public class QLSanPham_GUI extends JInternalFrame implements ActionListener {

    private static final long serialVersionUID = 1L ;
    private JSeparator phanCach;
    private Table tblSanPham;
    private JTextField txtTim;
    public DefaultTableModel tableModelSanPham;
    ...
    private void GUI() {
        ...
        tblSanPham = new Table();
        tblSanPham.setModel(tableModelSanPham);
    ...
    private void ChucNang() {
        ...
        btnTim.setIcon(new ImageIcon("/search_16.png"));
...
//        searchPanel.add(btnTim);
        ...
        txtTim.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                tableModelSanPham.getDataVector().removeAllElements();
                tableModelSanPham.fireTableDataChanged();
                switch (luachon) {
                case "Tất cả":
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(btnThem)) {
            ...
            ThemSanPham_Dialog a;
            a = new ThemSanPham_Dialog(this, (JFrame) SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
        ...
        if (e.getSource().equals(btnXoa)) {
            ...
            try {
                SanPham sp = getSanPhanSelect();
                String tenKH = sp.getTenSP();
                int confirm = JOptionPane.showConfirmDialog(this,
                    "<html><p style='text-align: center; font-size: 18px; color:red'>Cảnh báo</p>" +
                    "<p style='text-align: center;'>Xóa sản phẩm <span style='color: blue'>" + tenKH + "</span>?</p>" +
        ...
        if (e.getSource().equals(btnCapNhat)) {
            ...
            if (tblSanPham.getSelectedRow() == -1) {
                ...
                SuaSanPham_Dialog u = new SuaSanPham_Dialog(this, (JFrame) SwingUtilities.getWindowAncestor(this), rootPaneCheckingEnabled);
                u.setVisible(true);
            }
        }
    ...
    private void DocDuLieuDVVaoTable() {
        if (dsSP == null || dsSP.size() <= 0)
            return;
        for (SanPham item: dsSP) {
            double number = item.getGiaSP();
            DecimalFormat df = new DecimalFormat("#,###.##");
            String donGia = df.format(number);
            tableModelSanPham.addRow(new Object[] {
                item.getMaSP(), item.getTenSP(), item.getMoTa(), donGia, item.getSoLuongSP()
            });
    ...
    public SanPham getSanPhanSelect() {
