   ...
   public DefaultTableModel tableModel;
	...
	private DefaultComboBoxModel<String> modelLuaChon;
	 ArrayList<KhachHang> dsKH;
	   ...
	   private ThemKhachHang_Dialog themkhachhangdialog;
			...
			if(e.getSource().equals(btnHuyTim)) {
			 ...
			 if (e.getSource().equals(btnThem)) {
				...
				if (e.getSource().equals(btnXoa)) {
				    ...
				    try {
				        KhachHang nv = getKhachHangSelect();
				        String tenKH = nv.getTenKH();
				        ...
				        if (confirm == JOptionPane.YES_OPTION) {
				            KhachHangDAO.getInstance().delete(nv);
...
//		              String ngayvaolam = formatDate(item.getNgayVaoLam());
			...
			public KhachHang getKhachHangSelect() {
			    ...
			    return KhachHangDAO.getInstance().getKhachHangTheoMa(maNV);
			}
