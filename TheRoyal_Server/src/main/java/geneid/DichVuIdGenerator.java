...
public class DichVuIdGenerator implements IdentifierGenerator {
    @Override
    public Object generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o) throws HibernateException {
        EntityManager em = JPAUtil.getEntityManager();
        try {
            // Bước 1: Tìm maDDP lớn nhất hiện tại
            String jpql = "SELECT dv.maDV FROM DichVu dv ORDER BY dv.maDV DESC";
            ...
            return String.format("DV%02d", nextNumber);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
